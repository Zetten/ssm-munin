...
#
# syslog_ident: Defaults to "", which makes munin-node use its default of
# "munin-node".
#
# syslog_facility: Defaults to "", which makes munin-node use the perl
# Net::Server module default of "daemon". Possible values are any
